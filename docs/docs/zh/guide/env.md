...
| **ATK_ADMIN_NOTIFY_TELEGRAM_API_ENDPOINT** | `""` | 自定义 Telegram Bot API 端点 (例如: https://tg.example.com) | admin_notify.telegram.api_endpoint (多元推送 > Telegram > 自定义 Telegram Bot API 端点) |
